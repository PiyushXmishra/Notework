...
export default function ContinuewithGoogle() {
  ...
  return (
     <div className="">
      <button className=" flex row gap-2 items-center justify-center p-3 mt-4 bg-colorGradient2 hover:bg-black dark:bg-colorGradient1 rounded-xl  text-white font-bold w-full px-8 " onClick={googleAuth}>
        Continue with{" "}
        <svg
