...
export default function Transcribe() {
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
     ...
     setOutput("Oops, Something went wrong, try another video")
    }
  };
  ...
  return (
    <AuthProvider>
      <div className={`flex flex-col gap-4 dark:bg-colorGradient2  ${(!activity?.heading || activity?.heading.length===0)? 'h-screen' : 'h-11/12'}  `}>
  ...
  {(isDisable || output) && <img
                ...
                /> }{ isDisable && <div className="flex justify-center items-center  ">
